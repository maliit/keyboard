...
KeyPad {
    ...
    Column {
        ...
        Row {
            ...
            CharKey { label: "ø"; shifted: "Ø"; extended: ["ö"]; extendedShifted: ["Ö"] }
            CharKey { label: "æ"; shifted: "Æ"; extended: ["ä"]; extendedShifted: ["Ä"]; rightSide: true; }
        }
        ...
        Item {
            ...
            UrlKey         { id: urlKey; label: ".no"; extended: [".com", ".net"]; anchors.right: dotKey.left; height: parent.height; }
