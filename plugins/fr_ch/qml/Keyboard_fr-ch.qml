...
KeyPad {
    ...
    Column {
        ...
        Row {
            ...
            CharKey { label: "q"; shifted: "Q"; extended: ["1", "à","â","æ","á","ã","ä"]; extendedShifted: ["1", "À","Â","Æ","Á","Ã","Ä"]; leftSide: true; }
            ...
            CharKey { label: "z"; shifted: "Z"; extended: ["6", "ÿ","¥"]; extendedShifted: ["6", "Ÿ","¥"] }
        ...
        Row {
            ...
            CharKey { label: "é"; shifted: "É"; rightSide: true; }
        }
