...
KeyPad {
    ...
    Column {
        ...
        Row {
            ...
            CharKey { label: "ŝ"; shifted: "Ŝ"; extended: ["1", "q"]; extendedShifted: ["1", "Q"]; leftSide: true; }
            CharKey { label: "ĝ"; shifted: "Ĝ"; extended: ["2", "w"]; extendedShifted: ["2", "W"] }
            ...
            CharKey { label: "ŭ"; shifted: "Ŭ"; extended: ["6", "y"]; extendedShifted: ["6", "Y"] }
        ...
        Row {
            ...
            CharKey { label: "ĉ"; shifted: "Ĉ"; extended: ["x"]; extendedShifted: ["X"] }
            CharKey { label: "c"; shifted: "C"; extended: ["ç"]; extendedShifted: ["Ç"] }
            CharKey { label: "v"; shifted: "V"; extended: ["w"]; extendedShifted: ["W"] }
