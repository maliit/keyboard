...
KeyPad {
    ...
    Column {
        ...
        Row {
            ...
            CharKey { label: "ü"; shifted: "Ü"; extended: ["2", "w"]; extendedShifted: ["2", "W"] }
            ...
            CharKey { label: "i"; shifted: "İ"; extended: ["8", "î","ï","ì","í"]; extendedShifted: ["8", "Î","Ï","Ì","Í"] }
            ...
            CharKey { label: "ğ"; shifted: "Ğ"; rightSide: true; }
        }
        ...
        Row {
            ...
            CharKey { label: "ı"; shifted: "I"; }
            CharKey { label: "ə"; shifted: "Ə"; rightSide: true; }
        }
        ...
        Item {
            ...
            UrlKey         { id: urlKey; label: ".com"; extended: [".az", ".co.uk", ".net", ".org", ".edu", ".gov", ".ac.uk"]; anchors.right: dotKey.left; height: parent.height; }
