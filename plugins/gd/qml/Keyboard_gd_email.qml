...
KeyPad {
    ...
    Column {
        ...
        Row {
            ...
            CharKey { label: "a"; shifted: "A"; extended: ["1", "à", "á", "â", "ä", "å", "ã", "ā", "æ"]; extendedShifted: ["1", "À", "Á", "Â", "Ä", "Å", "Ã", "Ā", "Æ"] }
            ...
            CharKey { label: "p"; shifted: "P"; extended: ["ṗ"]; extendedShifted: ["Ṗ"] }
        }
        ...
        Item {
            ...
            UrlKey         { id: urlKey; label: ".uk"; extended: [".co.uk", ".org.uk", ".ac.uk", ".me.uk", ".gov.uk", ".ltd.uk", ".com", ".net"]; anchors.right: dotKey.left; height: parent.height; }
