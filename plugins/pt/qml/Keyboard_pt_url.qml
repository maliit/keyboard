...
KeyPad {
    ...
    Column {
        ...
        Item {
            ...
            UrlKey         { id: urlKey; label: ".com.br"; extended: [".pt", ".mz", ".ao", ".gw", ".tl"]; anchors.right: dotKey.left; height: parent.height; width: panel.keyWidth + units.gu(UI.emailLayoutUrlKeyPadding + 0.5); }
