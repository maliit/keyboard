...
KeyPad {
    ...
    Column {
        ...
        Item {
            ...
            UrlKey         { id: urlKey; label: ".com"; extended: [".pt", ".net", ".org", ".edu", ".gov", ".com.pt"]; anchors.right: dotKey.left; height: parent.height; width: panel.keyWidth + units.gu(UI.emailLayoutUrlKeyPadding + 0.5); }
