...
KeyPad {
    ...
    Column {
        ...
        Item {
            ...
            UrlKey         { id: urlKey; label: ".com"; extended: [".pt", ".net", ".org", ".edu", ".gov", ".com.pt"]; anchors.right: dotKey.left; height: parent.height; width: panel.keyWidth + Device.emailLayoutUrlKeyPadding + Device.gu(0.5); }
