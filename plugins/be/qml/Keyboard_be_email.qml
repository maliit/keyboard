...
KeyPad {
    ...
    Column {
        ...
        Row {
            ...
            CharKey { label: "е"; shifted: "Е"; extended: ["5"]; extendedShifted: ["5", "Ё", "€"] }
            CharKey { label: "н"; shifted: "Н"; extended: ["6"]; extendedShifted: ["6"] }
            CharKey { label: "г"; shifted: "Г"; extended: ["ґ"]; extendedShifted: ["Ґ"] }
            CharKey { label: "ш"; shifted: "Ш"; extended: ["7"]; extendedShifted: ["7"] }
        ...
        Item {
            ...
            UrlKey         { id: urlKey; label: ".by"; extended: [".com",".by",".бел"]; anchors.right: dotKey.left; height: parent.height; }
